...
<form id="accesspanel" action="table.php" method="post">
  <h1 id="litheader">SEARCH</h1>
  <div class="inset">
    <p>
      <input type="text" name="s"  placeholder="Search for ID" required>
    </p>
  </div>
  <p class="p-container">
    <input type="submit" name="Login" id="go" ><br><br>
  </p>
